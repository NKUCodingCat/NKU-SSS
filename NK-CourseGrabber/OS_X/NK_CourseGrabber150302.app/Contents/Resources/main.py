...
class Application_ui(Frame):
	...
	def __init__(self, master=None):
		...
		self.master.title('一键刷课 for NKU V2.1.1')
	...
	def createWidgets(self):
		...
		self.Option1.place(relx=0.488, rely=0.424, relwidth=0.127, relheight=0.036)
		...
		self.Option2.place(relx=0.488, rely=0.475, relwidth=0.127, relheight=0.036)
